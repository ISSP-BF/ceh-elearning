...
/**
 * Strings for component 'plagiarism_copyleaks', language 'fr', version '3.11'.
 *
...
$string['cldefaultrepositoriespagetitle'] = 'Paramètres de dépôts par défaut de Copyleaks';
$string['cldefaultsettings'] = 'Paramètres par défaut du plugin de plagiat Copyleaks';
...
$string['cleditrepositories'] = 'Modifier les paramètres des référentiels';
...
$string['clignorequotes'] = 'Ignorer les citations';
$string['clignorereferences'] = 'Ignorer les références';
$string['clignoreresourcecodecomments'] = 'Ignorer les commentaires du code source';
$string['clignoreretableofcontents'] = 'Ignorer la table des matières';
$string['clignoretitles'] = 'Ignorer les titres';
...
$string['clrepositoriespagetitle'] = 'Paramètres des référentiels Copyleaks';
$string['clscaninternaldatabase'] = 'Scanner la base de données interne';
$string['clscaninternet'] = 'Scanner Internet';
