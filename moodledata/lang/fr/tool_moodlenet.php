...
/**
 * Strings for component 'tool_moodlenet', language 'fr', version '3.11'.
 *
...
$string['aria:footermessage'] = 'Consultez les contenus de MoodleNet';
$string['browsecontentmoodlenet'] = 'Ou consultez les contenus de MoodleNet';
$string['clearsearch'] = 'Réinitialiser la recherche';
$string['connectandbrowse'] = 'Connectez-vous et consultez :';
...
$string['moodlenetsettings'] = 'Réglages MoodleNet';
