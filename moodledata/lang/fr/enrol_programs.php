...
/**
 * Strings for component 'enrol_programs', language 'fr', version '3.11'.
 *
...
$string['privacy:metadata:field:timestarted'] = 'Date du début du programme';
...
Votre inscription au programme « {$a->program_fullname} » a été approuvée, la date de début est le {$a->program_startdate}.';
...
Le programme « {$a->program_fullname} » vous a été attribué, la date de début est le {$a->program_startdate}.';
$string['source_base_notification_allocation_subject'] = 'Notification de l\'attribution du programme';
$string['source_base_notification_deallocation_body'] = 'Bonjour {$a->user_fullname},

Votre inscription au programme « {$a->program_fullname} » a été approuvée, la date de début est le {$a->program_startdate}.';
$string['source_base_notification_deallocation_subject'] = 'Notification de retrait du programme';
...
Vous vous êtes inscrit au programme « {$a->program_fullname} », la date de début est le {$a->program_startdate}.';
$string['source_selfallocation_notification_allocation_subject'] = 'Notification de l\'attribution du programme';
