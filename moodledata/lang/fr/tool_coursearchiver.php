...
$string['optoutarchivemessage'] = 'Je ne souhaite pas archiver le cours suivant :

{$a}

Merci.';
$string['optoutarchivesubject'] = 'Veuillez ne pas archiver mon cours';
$string['optoutby'] = 'Demandé par';
$string['optouthide'] = 'Ne pas cacher ce cours';
$string['optouthidemessage'] = 'Je ne souhaite pas masquer le cours suivant :

{$a}

Merci.';
$string['optouthidesubject'] = 'Veuillez ne pas masquer mon cours';
